...
INTERFACE{INTERFACE}
VAR
  Ones, Tens, Hundreds, Thousand: CHAR;
PROCEDURE Start;{Инициализация счетчика}
PROCEDURE Bump(VAR Thousand: CHAR);{Увеличивает счётчик на едницу, если он находится в диапазоне }
...
PROCEDURE Bump(VAR Thousand: CHAR);
